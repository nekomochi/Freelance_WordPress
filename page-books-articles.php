...
$get_page_image = $get_body['intro_bg_image'];
?>
<div class="books books-bg detail-page" style="background: url('<?php if($get_page_image) : echo $get_page_image; else : echo get_bloginfo('template_directory'); ?>/images/stories/stories_bg.png<?php endif; ?>') no-repeat top right; background-size:cover;">
...
<?php 
		if(have_posts()):while(have_posts()):the_post();
			get_template_part('content-books-articles', get_post_format());
		endwhile; endif;
		?>
