          ...
          <div class="row pb-3">
            ...
            foreach($tagsArray as $key => $value){
              ...
              if($key == 0) {
                ...
                $tagsIDArray[] = get_term_by('name', $value, 'post_tag')->term_id;
              } else {
                $remainingTags[] = get_term_by('name', $value, 'post_tag')->term_id;
              }
            ...
            if($get_drop_check == 'yes') {
              ...
              //for double dropdown
              $addrepeater = $get_select_group['dropdown_repeater'];
              $selectParent = $get_select_group['page_filter_second'];
              if($selectParent){
                echo $selectParent->name;
              }

              if($addrepeater): 


                foreach($addrepeater as $row):
                  
                $addfilter = $row['page_filter'];
               print_r($row);
            ...
            ?>
                  <div class="col-3">
                    ...
                    <select class="custom-select multi-sort shadow-sm">
                    <?php
                      foreach($addfilter as $a):
                        $getname = $a->name;
                        $getslug = $a->slug;
             ...
             <?php
              endif; //if addrepeater

            endif;// if get_drop_option
              ?>
